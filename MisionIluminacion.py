...
def draw_sphere(radius, slices=30, stacks=30):
    ...
    # TAREA DE LA MISIÓN 2:
    # GLU_SMOOTH calcula una normal por vértice, lo que hace que 
    # la transición de luz entre las caras de la esfera sea invisible.
    gluQuadricNormals(quad, GLU_SMOOTH)
    
    # Dibujamos la esfera (ahora con sus normales activas)
